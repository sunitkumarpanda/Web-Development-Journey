...
var isTodayRaining = false;
var isTodaySunny = true;
console.log(isTodayRaining);
console.log(isTodaySunny);
...
var myGirl = "trupti";
console.log("My girl name is " + myGirl);
console.log(typeof myGirl);
...
var myFevNum = "100";
console.log(myFevNum);
console.log(typeof myFevNum);
console.log(typeof +myFevNum);
console.log(typeof Number(myFevNum));
...
console.log(isNaN("Raj is sitting here"));
