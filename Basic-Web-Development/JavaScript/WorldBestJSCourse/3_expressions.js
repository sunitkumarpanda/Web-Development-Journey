...
console.log("Yes answer is Correct: " + "5" + 3);
...
console.log(2 < 12 < 5); // 2 < 12 = T / 1 < 5 = True

console.log("20" + 10 + 10); //String type so no plush
